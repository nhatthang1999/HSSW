...
function Sidebar({ sidebarOpen, setSidebarOpen, routes, path }) {
            ...
            (route, key) =>
              route.isInSidebar && (
                ...
                <NavLink
                  ...
                  key={key}
                  className={`block text-gray-200 hover:text-gray-800 hover:bg-blue-50 transition duration-150 px-3 py-2 rounded-md mb-0.5 last:mb-0 ${
                    page === "" && "hover:text-gray-200 "
                  }`}
                  isActive={(match, location) => {
                    return pathname.indexOf(route.path) === 0 ? true : false;
                  }}
                >
